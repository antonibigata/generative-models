...
srun python main.py --resume logs/2024-09-06T14-45-07_example_training-svd_keyframes_emotion --base configs/example_training/svd_keyframes_emotion.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.balance_datasets=True data.params.train.datapipeline.need_cond=True data.params.train.datapipeline.get_separate_id=True 