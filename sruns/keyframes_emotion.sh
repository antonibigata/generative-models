...
srun python main.py --base configs/example_training/svd_keyframes_emotion.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.select_randomly=True 'model.params.to_freeze=["time_"]' 'model.params.to_unfreeze=["time_embed"]' \
