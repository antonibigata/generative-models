...
srun python main.py --base configs/example_training/svd_keyframes_emo_cross.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.balance_datasets=True model.params.ckpt_path=logs/2024-09-10T13-46-16_example_training-svd_keyframes_emo_cross/checkpoints/last.ckpt/checkpoint/mp_rank_00_model_states.pt 'model.params.remove_keys_from_weights=[]' \
    data.params.train.datapipeline.need_cond=True data.params.train.datapipeline.get_separate_id=True