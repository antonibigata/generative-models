...
srun python main.py --base configs/example_training/svd_keyframes_emo_labels.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.balance_datasets=True data.params.train.datapipeline.add_extra_audio_emb=True \
    model.params.loss_fn_config.params.weight_pixel=1 'model.params.loss_fn_config.params.what_pixel_losses=["lpips", "l2"]' \
