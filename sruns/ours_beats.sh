...
srun python main.py --base configs/example_training/keyframes_no_beats.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    model.params.loss_fn_config.params.n_frames_pixel=1 data.params.train.datapipeline.audio_emb_type=beats
