...
srun python main.py --base configs/example_training/svd_keyframes_emo_cross_pixel.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.balance_datasets=False model.params.loss_fn_config.params.weight_pixel=1 'model.params.loss_fn_config.params.what_pixel_losses=["lpips"]' \
