...
srun python main.py --base configs/example_training/svd_image_lora.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    model.params.lora_config.search_class_str=linear model.params.lora_config.target_replace_module=null \
