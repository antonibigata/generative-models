...
srun python main.py --resume logs/2024-10-31T12-43-44_example_training-svd_interpolation_cross --base configs/example_training/svd_interpolation_cross.yaml --wandb True lightning.trainer.num_nodes 8 \
