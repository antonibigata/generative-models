...
srun python main.py --resume logs/2024-06-26T10-12-35_example_training-svd_image_land --base configs/example_training/svd_image_land.yaml --wandb True lightning.trainer.num_nodes 8 \
