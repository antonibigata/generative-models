...
srun python main.py --resume logs/2024-07-18T09-00-45_example_training-svd_image_land --base configs/example_training/svd_image_land.yaml --wandb True lightning.trainer.num_nodes 8 \
