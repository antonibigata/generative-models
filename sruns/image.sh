...
srun python main.py --resume logs/2024-07-12T14-16-48_example_training-svd_image --base configs/example_training/svd_image.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.audio_folder=audio_crop_emb \
