...
srun python main.py --base configs/example_training/svd_image.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    model.params.loss_fn_config.params.lambda_lower=2. model.params.network_config.params.skip_time=False data.params.train.datapipeline.n_out_frames=4 model.params.network_config.params.additional_audio_frames=0 \
