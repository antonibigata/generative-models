...
srun python main.py --resume logs/2024-06-11T17-26-26_example_training-svd_image --base configs/example_training/svd_image.yaml --wandb True lightning.trainer.num_nodes 4 \
