...
srun python main.py --resume logs/2024-09-29T16-30-58_example_training-keyframes_no_beats --base configs/example_training/keyframes_no_beats.yaml --wandb True lightning.trainer.num_nodes 8 \
