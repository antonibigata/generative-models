...
#SBATCH --no-requeue
#SBATCH --account all
#SBATCH --exclude=a100-st-p4d24xlarge-4,a100-st-p4d24xlarge-5,a100-st-p4d24xlarge-12,a100-st-p4d24xlarge-4
...
srun python main.py --resume logs/2024-09-03T15-50-57_example_training-svd_interpolation_no_emb --base configs/example_training/svd_interpolation_no_emb.yaml --wandb True lightning.trainer.num_nodes 8 \
