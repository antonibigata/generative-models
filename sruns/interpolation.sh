...
#SBATCH --no-requeue
#SBATCH --account all
#SBATCH --exclude=a100-st-p4d24xlarge-52,a100-st-p4d24xlarge-53source /data/home/antoni/miniconda3/etc/profile.d/conda.sh
conda activate svd
...
srun python main.py --base configs/example_training/svd_interpolation_no_emb.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    model.params.loss_fn_config.params.lambda_lower=2. data.params.train.datapipeline.balance_datasets=False 