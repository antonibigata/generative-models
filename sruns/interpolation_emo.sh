...
srun python main.py --base configs/example_training/svd_interpolation_cross.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    'model.params.to_freeze=[]' 'model.params.to_unfreeze=[]' data.params.train.loader.batch_size=1 \
    ...
    model.params.loss_fn_config.params.weight_pixel=1 'model.params.loss_fn_config.params.what_pixel_losses=["l2", "lpips"]' \
    model.params.loss_fn_config.params.n_frames_pixel=1 