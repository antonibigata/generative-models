...
srun python main.py --base configs/example_training/svd_image_dub.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    data.params.train.datapipeline.change_file_proba=1. data.params.train.datapipeline.what_mask=box \
