...
vid_to_init_frame = {
    # "M003": "/data/home/stellab/projects/facial_animation_gitrepos/EAT_code/mead_data/images_evp_25/new_neutral_2/M003/M003.jpg",
    "M030": "/fsx/behavioural_computing_data/face_generation_data/MEAD/video_crop/M030/video/front/neutral/level_1/002.mp4",
    "W009": "/fsx/behavioural_computing_data/face_generation_data/MEAD/video_crop/W009/video/front/neutral/level_1/002.mp4",
    "W015": "/fsx/behavioural_computing_data/face_generation_data/MEAD/video_crop/W015/video/front/neutral/level_1/002.mp4",
}
...
def create_pipeline_inputs(
    ...
    for i in range(0, audio.shape[0] - num_frames + 1, step):
        try:
            audio_interpolation[i : i + num_frames]
        except IndexError:
        ...
        if i not in audio_image_preds_idx:
            ...
            if emotions is not None:
                emotions_chunks.append((emotions[0][i], emotions[1][i], emotions[2][i]))
        ...
        if segment_end - 1 not in audio_image_preds_idx:
            ...
            # )
        # print("emotions_chunks: ", emotions_chunks)
    ...
    if add_zero_flag:
        ...
        if emotions is not None:
            first_element_emotions = (emotions[0][0], emotions[1][0], emotions[2][0])
...
def sample_keyframes(
    ...
    for i in range(audio_list.shape[0]):
        ...
        if labels_list is not None:
            value_dict["emo_labels"] = labels_list[i].unsqueeze(0)
...
def sample(
    ...
    for input_img_path in all_img_paths:
        ...
        if emotions is not None:
            ...
            labels_list = rearrange(labels_list, "(b t) -> b t", t=num_frames)
        ...
        for chunk_start in range(0, len(audio_cond), chunk_size):
            ...
            chunk_labels_list = labels_list[chunk_start:chunk_end].cuda() if labels_list is not None else None
        ...
        # if isinstance(complete_video, list):
        #     complete_video = np.concatenate(complete_video, axis=0)
