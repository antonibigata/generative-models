...
class ScaleLandmarks(object):
    """
    Scale the landmarks so they are in the shape of image
    Args:
        original_im_size, new_im_size
    """

    def __init__(self, original_im_size, new_im_size):
        self.original_im_size = original_im_size
        self.new_im_size = new_im_size

    def __call__(self, landmarks):
        
        # print(self.new_im_size, self.original_im_size)
        return landmarks * ( self.new_im_size / self.original_im_size)
