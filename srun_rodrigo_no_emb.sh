...
srun python main.py --base configs/example_training/svd_interpolation_no_emb.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    model.params.ckpt_path=/data/home/rs2517/code/generative-models/logs/2024-04-26T18-26-41_example_training-svd_interpolation_no_emb/checkpoints/last.ckpt/checkpoint/mp_rank_00_model_states.pt \
