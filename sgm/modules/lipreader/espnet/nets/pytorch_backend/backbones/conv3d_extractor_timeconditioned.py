...
from sgm.modules.lipreader.espnet.nets.pytorch_backend.backbones.modules.resnet_timeconditioned import (
    BasicBlock,
    ResNet,
)
...
class Conv3dResNetTimeConditioned(nn.Module):
    """Conv3dResNetTimeConditioned module"""
    ...
    def __init__(self, backbone_type="resnet", relu_type="swish"):
        ...
        """
        super(Conv3dResNetTimeConditioned, self).__init__()
