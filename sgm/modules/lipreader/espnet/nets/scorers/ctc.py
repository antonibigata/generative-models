...
from sgm.modules.lipreader.espnet.nets.ctc_prefix_score import CTCPrefixScore, CTCPrefixScoreTH
from sgm.modules.lipreader.espnet.nets.scorer_interface import BatchPartialScorerInterface
