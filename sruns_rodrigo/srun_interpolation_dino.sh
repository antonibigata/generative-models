...
cd /data/home/dinovgk/project/generative-models
srun python main.py --resume logs/2024-10-01T20-12-00_example_training-svd_interpolation_cross --base configs/example_training/svd_interpolation_cross.yaml --wandb True lightning.trainer.num_nodes 8 \
    ...
    'model.params.to_freeze=[]' 'model.params.to_unfreeze=[]' data.params.train.loader.batch_size=2 \
    model.params.loss_fn_config.params.lambda_lower=2. data.params.train.datapipeline.balance_datasets=False data.params.train.datapipeline.add_extra_audio_emb=True \
